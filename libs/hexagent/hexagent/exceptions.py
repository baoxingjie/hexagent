"""Exceptions for HexAgent.

This module defines exceptions raised by HexAgent tools and components.
"""
...
class LimaError(VMError):
    ...
    Examples:
        ```python
        # VM did not start
        raise LimaError("Lima instance 'hexagent' did not reach Running state within 120s")
...
class WslError(VMError):
    ...
    Examples:
        ...
        raise WslError("WSL distro 'hexagent' did not start within 60s")
