...
from hexagent.tools.cli.bash import BashTool
from hexagent.tools.cli.edit import EditTool
from hexagent.tools.cli.glob import GlobTool
from hexagent.tools.cli.grep import GrepTool
from hexagent.tools.cli.read import ReadTool
from hexagent.tools.cli.write import WriteTool
...
def create_filesystem_tools(computer: Computer) -> list[BaseAgentTool[Any]]:
    ...
    Example:
        ```python
        from hexagent.computer import LocalComputer
        from hexagent.tools.cli import create_filesystem_tools
