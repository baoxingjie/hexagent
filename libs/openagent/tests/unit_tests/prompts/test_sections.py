...
from openagent.prompts import FRESH_SESSION, RESUMED_SESSION, SUBAGENT_SESSION, compose
...
class TestSubagentSession:
    def test_excludes_root_sections(self) -> None:
        ...
        # Identity section starts with "You are OpenAgent"
        assert "You are OpenAgent" not in result
